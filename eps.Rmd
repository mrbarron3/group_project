...
a = ggplot(emi_90_20) +
  ...
  labs(x = "", y = "EPSI", title = "Environmental Policy Stringency Index (EPSI) by Country and Year", subtitle = "Only Includes Countries Where Both 2020 and 1990 Data is Available")
```
...
b = ggplot(emissions_diff) +
  ...
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) +
  labs(x = "Country", y = "Increase Amount", title = "Increase Between 1990 and 2020 Environmental Policy Stringency Index") +
  scale_y_continuous(expand = c(0, 0))
```
